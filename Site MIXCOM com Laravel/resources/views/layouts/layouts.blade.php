    ...
    <div class="container-fluid">
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light" style=" background-color: #e3f2fd; ">
            <a class="navbar-brand" href="#">
                <img class="img-responsive" src="{{asset('imagens/logo.png')}}" width="150px" class="img-responsive" alt=""></a>
                    ...
                    <li class="dropdown-item dropdown-submenu dropright">
                        ...
                        <ul class="dropdown-menu">
                            <li class="text-dark dropdown-item">
                                <a href="produtocatraca.html">Catracas</a>
                            </li>
                            <li class="text-dark dropdown-item">
                                <a href="#">Controlador De Acesso Por Biometria Facil</a>
                            </li>
                            <li class="text-dark dropdown-item">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                ...
                <div class="btn-group-vertical btn-block btn-group-lg" role="group">
                    <a class="btn btn-outline-primary" href="https://www.facebook.com/Mixcompontoeacesso/?timeline_context_item_type=intro_card_work&timeline_context_item_source=100003811757067&fref=tag"><i class="fab fa-facebook"></i> Facebook</a>
